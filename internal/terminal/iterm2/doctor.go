...
func DoctorChecks() []Check {
	...
	if runtime.Ready {
		...
		checks = append(checks, Check{Name: "iterm2_python_runtime", Status: "warn", Detail: "not ready; installer will attempt auto-provisioning and fail safe if provisioning is unavailable: " + runtime.Reason})
	}
	return checks
}
