...
- The iTerm2 integration acts only when the installed paste shortcut is invoked. It uses Python RPC only when the iTerm2 runtime is ready; runtime-missing no-Python Cmd+V hooks are disabled because they can pollute ordinary paste.
