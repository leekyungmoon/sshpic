...
- Native installer commands with shared behavior: Windows uses `./scripts/windows/install.ps1` in the current PowerShell 7 process; macOS and Linux use `./install.sh` in the current shell.
